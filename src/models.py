...
class Client(Base):
    ...
    villecli_id = Column(Integer, default=None)
...
class Commande(Base):
	...
	codcli = Column(Integer,default=None)
	timbrecli = Column(Float, default=None)
	timbrecde = Column(Float, default=None)
	nbcolis = Column(Integer, default=None)
	cheqcli = Column(Float, default=None)
	idcondit = Column(Integer, default=None)
	cdeComt = Column(String(255), default=None)
	barchive = Column(Integer, default=None)
	bstock = Column(Integer, default=None)
